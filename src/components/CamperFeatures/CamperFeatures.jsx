...
const CamperFeatures = () => {
  ...
  const { adults, transmission, engine, details, form, length, width, height, tank, consumption } = item;
    ...
    <div className={css.box}>
        ...
        <div className={css.detailsBox}>
            ...
            <div className={css.details}>
                ...
                <p className={css.detailsText}>{`${details.airConditioner} air conditioner`}</p>
            </div>
            <div className={css.details}>
                <svg className={css.iconDetails}>
