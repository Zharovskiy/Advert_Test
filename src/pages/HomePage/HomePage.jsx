  ...
  return (
    <section>
      ...
      <p className={css.text}>
        ...
        Camper Haven is your ultimate destination for comfort and convenience on
        wheels.
      </p>
      ...
      <ul className={css.list}>
        ...
        <li className={css.item}>
          <b>Easy Booking:</b> Our straightforward booking process ensures that
          you can reserve your perfect camper in just a few clicks.
        </li>
        <li className={css.item}>
      ...
      <p className={css.text}>
        Embark on your adventure today and experience the joy of traveling in a
        camper that feels like home.
      </p>
